...
function L6_1(A0_2)
  ...
  if L2_2 then
    ...
    L3_2 = L3_2.server
    L4_2 = L3_2
    L3_2 = L3_2.loadUserInfoByText
    L5_2 = {}
    L5_2.text = L2_2
    L5_2.byDeviceId = true
    L3_2(L4_2, L5_2)
  end
end
L5_1.action = L6_1
...
L5_1 = {}
L5_1.id = "md_next"
L5_1.template = "md_action"
function L6_1(A0_2)
  local L1_2, L2_2, L3_2, L4_2, L5_2, L6_2
  L1_2 = L0_1
  L2_2 = L1_2
  L1_2 = L1_2.getObj
  L3_2 = "moder_device_list"
  L1_2 = L1_2(L2_2, L3_2)
  L2_2 = L1_2.pageNum
  if not L2_2 then
    L2_2 = 1
...
function L6_1()
  ...
  L2_2 = {}
  L2_2.loadToFile = true
  L2_2.maxLoadTime = 60000
  L2_2.loadCount = 100
  L2_2.loadLimit = 200
  L2_2.category = 14
  L0_2(L1_2, L2_2)
...
function L6_1(A0_2, A1_2)
  ...
  L2_2(L3_2, L4_2, L5_2)
  L2_2 = A1_2.response
  A0_2.deviceList = L2_2
  A0_2.pageNum = 1
  L2_2 = A0_2.deviceList
  if L2_2 then
    L2_2 = math
    L2_2 = L2_2.ceil
    L3_2 = A0_2.deviceList
    L3_2 = #L3_2
    L4_2 = L2_1
    L3_2 = L3_2 / L4_2
    L2_2 = L2_2(L3_2)
